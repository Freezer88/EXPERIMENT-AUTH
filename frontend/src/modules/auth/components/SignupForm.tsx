...
const SignupForm: React.FC<SignupFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Don't clear errors here - they should persist until form is valid
  ...
  const isFormValid = !isSubmitting; // Allow submission even with empty fields to trigger validation

  const validateForm = (): boolean => {
    const newErrors: FormErrors = {};

    // Use form state for validation
